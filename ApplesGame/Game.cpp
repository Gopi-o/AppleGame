...
namespace ApplesGame
{
	...
	void InitGameState(Game& game, GameState& state)
	{
		...
		case GameStateType::Records:
		{
			...
			InitRecords(*(GameStateRecordsData*)state.data, game);
			break;
		}
		default:
	...
	void ShutdownGameState(Game& game, GameState& state)
	{
		...
		case GameStateType::Records:
		{
			ShutdownRecords(*(GameStateRecordsData*)state.data, game);
	...
	void HandleWindowEventGameState(Game& game, GameState& state, sf::Event& event)
	{
		...
		case GameStateType::Records:
		{
			HandleRecordsWindowEvent(*(GameStateRecordsData*)state.data, game, event);
			break;
		}
		default:
			assert(false); // We want to know if we forgot to implement new game state
	...
	void UpdateGameState(Game& game, GameState& state, float timeDelta)
	{
		...
		case GameStateType::Records:
		{
			UpdateRecords(*(GameStateRecordsData*)state.data, game, timeDelta);
			break;
		}
		default:
			assert(false); // We want to know if we forgot to implement new game state
	...
	void DrawGameState(Game& game, GameState& state, sf::RenderWindow& window)
	{
		...
		case GameStateType::Records:
		{
			DrawRecords(*(GameStateRecordsData*)state.data, game, window);
			break;
		}
		default:
			assert(false); // We want to know if we forgot to implement new game state
